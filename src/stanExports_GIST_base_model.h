...
namespace model_GIST_base_model_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_GIST_base_model");
    reader.add_event(58, 56, "end", "model_GIST_base_model");
    return reader;
}
#include <stan_meta_header.hpp>
class model_GIST_base_model
  : public stan::model::model_base_crtp<model_GIST_base_model> {
private:
        int numGenes;
        int numCellTypes;
        vector_d exprMixVec;
        ...
        vector_d alpha;
public:
    model_GIST_base_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_GIST_base_model_namespace::model_GIST_base_model";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_GIST_base_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_GIST_base_model_namespace::model_GIST_base_model stan_model;
#ifndef USING_R
