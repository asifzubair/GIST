...
#include "stanExports_GIST_enhanced_model.h"

RCPP_MODULE(stan_fit4GIST_enhanced_model_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_GIST_enhanced_model")
