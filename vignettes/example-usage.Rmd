...
Let's pass the normalized spatial transcriptomics counts matrix and the signature matrix to `GIST` for deconvolution.

```{r}
st_props = GIST(st_counts[,1:2], sig_mat, num_cores = parallel::detectCores(), verbose = FALSE, refresh = 0)
```
